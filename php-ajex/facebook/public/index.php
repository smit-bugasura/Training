      ...
      <navbar class="navbar">
         ...
         <div class="profile-details">
            ...
            <span class="profiles profile-wrapper end">
               <img src="./images/user_<?php echo $_SESSION['user_id'] ?>.jpg" class="right-icons profile-icon"
                  height="40" width="40">
               ...
               <ul class="dropdown-menu-profile" id="dropdown-menu">
                  ...
                  <li>
                     <div class="link-icon"><i data-visualcompletion="css-img" class="x1b0d499 xep6ejk"
                        aria-hidden="true"
         ...
         <div class="gradiant-bg">
            <section class="main-section">
               <div class="profile-banner-image">
                  <img src="./images/llama.jpg" alt="" class="banner-image">
               </div>
                        ...
                        <div class="name-follow">
                           ...
                           <div class="right-profile-content">
                              <div class="follow-button">
                                 <img src="./images/follow-icon.png" alt=""
                                    aria-hidden="true" height="16" width="16">
                                 <span>Follow</span>
                              </div>
                              <div class="search-button">
                                 <img class="x1b0d499 xep6ejk"
                                    src="./images/search-icon.png" alt=""
                                    aria-hidden="true" height="16" width="16">
                                 <span>Search</span>
                              </div>
                        ...
                        <div class="ed-office-content">
                           <ul>
                              <li><span><img class="x1b0d499 xep6ejk" height="12" width="12"
                                 src="./images/public-figure.svg"
                                 width="12" alt=""></span> Public figure</li>
                              <span aria-hidden="true">·</span>
                              <li><span><img class="x1b0d499 xep6ejk" height="12" width="12"
                                 src="./images/location-pin.svg"
                                 width="12" alt=""></span> Palo Alto, California</li>
                              <span aria-hidden="true">·</span>
                              <li><span><img class="x1b0d499 xep6ejk" height="12" width="12"
                                 src="./images/office-building.svg"
                                 width="12" alt=""></span> Meta</li>
                              <span aria-hidden="true">·</span>
                              <li><span><img class="x1b0d499 xep6ejk" height="12" width="12"
            ...
            <div class="post-section">
               <div class="post-section-left">
                  <div class="personal-details">
                     ...
                     <h3>Communities</h3>
                     <div class="loaction-details personal-details-card">
                        <img class="x1b0d499 xep6ejk" height="24"
                     ...
                     <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        <div class="post-form-card-header">
                           ...
                           <div class="right-post-form-card-header">
                              <input type="text" name="post-text" placeholder="What's on your mind, Mark?">
                           </div>
                        </div>
                     ...
                     <div class="post-card-header">
                        <div class="left-post-card-header">
                           ...
                           <div class="post-profile-name">
                              <span>
                                 Mark Zuckerberg 
                                 <img src="./images/verified.svg" width="12" height="12" alt="Verified account" style="--x-color: var(--accent);">
                              </span>
                              <span>
               ...
               <div class="about-content">
                  ...
                  <div class="right-about-content">
                     <div class="intro-section">
                        <h4>Bio</h4>
                        <div>
                           <img class="x1b0d499 xep6ejk" height="24" width="24" alt=""
                              src="./images/handwave.svg">
